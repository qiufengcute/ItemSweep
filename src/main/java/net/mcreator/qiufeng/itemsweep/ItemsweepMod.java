...
import net.mcreator.qiufeng.itemsweep.init.ItemsweepModProcedures;
...
public class ItemsweepMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(ItemsweepMod.class);
	public static final String MODID = "itemsweep";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing ItemsweepMod");
		ItemsweepModVariables.variablesLoad();
		ItemsweepModGameRules.load();
		ItemsweepModProcedures.load();
		tick();
