package net.mcreator.qiufeng.itemsweep.network;
...
import net.mcreator.qiufeng.itemsweep.ItemsweepMod;
...
public class ItemsweepModVariables {
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>("itemsweep_worldvars", ctx -> new WorldVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>("itemsweep_mapvars", ctx -> new MapVariables(), ctx -> CompoundTag.CODEC.xmap(tag -> {
			MapVariables instance = new MapVariables();
			instance.read(tag, ctx.levelOrThrow().registryAccess());
			return instance;
		}, instance -> instance.save(new CompoundTag(), ctx.levelOrThrow().registryAccess())), null);
		boolean _syncDirty = false;
		public double SweepSeconds = 0.0;
		public double TempItemCount = 0;

		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			SweepSeconds = nbt.getDoubleOr("SweepSeconds", 0);
			TempItemCount = nbt.getDoubleOr("TempItemCount", 0);
		}

		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putDouble("SweepSeconds", SweepSeconds);
			nbt.putDouble("TempItemCount", TempItemCount);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(ItemsweepMod.MODID, "saved_data_sync"));
